  ...
  return (
    <div className="bg-[#2F394D] min-h-screen">
      ...
      <div className="space-y-4">
        <PracticeBar Name="ABCs" Description="Practice Signing Letters Of The Alphabet" />
        <PracticeBar Name="Words" Description="Practice Words You Know (Coming Soon)" />
        <PracticeBar Name="Endless" Description="How Many Words In A Row Can You Get (Coming Soon)" />
