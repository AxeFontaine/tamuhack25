    ...
    return (
        <div className="min-h-screen bg-[#2F394D]">
            ...
            <div className="space-y-16 justify-content-center items-center flex flex-col">
                ...
                {!isVisible && (
                    <div className="flex w-1/2 justify-center bg-[#3589a2] h-64 items-center rounded-2xl">
                        <div>
                            bye
                        </div>
                    </div>
                )}
                <button onClick={toggleVisibility} className="flex-column w-1/5 justify-self-center bg-[#330036] justify-center rounded-2xl duration-300 ease-in-out transform hover:scale-[1.01] hover:bg-[#6b0c70] text-[#EEE1B3] p-5">
                    {!isVisible ? (
